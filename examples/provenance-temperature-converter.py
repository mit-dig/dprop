...
def convertTempRange():
    ...
    if isinstance(data, dpropjson.Nothing):
        ...
        print "Converted provenance now %s" % (converted_cell.provenanceData())
...
try:
    ...
    name = '/pipian.com:37767/Cells/3679cac03dc411df98790800200c9a66'
    url = "https:/%s" % (name)
    
    temp_cell = pydprop.ProvenanceAwareRemoteCell(url, mergeRange)
    
    mainUUID = '069720e0-3dca-11df-9879-0800200c9a66'
    provUUID = 'ff8d10c0-3dc9-11df-9879-0800200c9a66'
    dataUUID = "46d081b0-3cf8-11df-9879-0800200c9a66"
    converted_cell = pydprop.ProvenanceAwareLocalCell(mainUUID, provUUID,
                                                      dataUUID, mergeRange)
    converterPropagator = pydprop.ProvenanceAwarePropagator('temp-converter',
                                                            [temp_cell],
                                                            [converted_cell],
                                                            convertTempRange)
